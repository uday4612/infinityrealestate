                            ...
                            <ul>
                                ...
                                <li class="d-flex mb-4"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        ...
                                        <span class="d-table text-secondary">+91 9173620768</span>
										<span class="text-secondary">+91 7778089203 </span><br>
										<span class="text-secondary">+91 9978893697 </span>
									</div>
                                </li>
                                <li class="d-flex mb-4"> <i class="fas fa-envelope text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        <h5 class="text-white">Email Adderss</h5>
										<span class="d-table text-secondary"><a href="mailto:infinityrealestate001@gmail.com" >infinityrealestate001@gmail.com</a></span>
										<span class="text-secondary"></span>
										</div>
                                </li>
                            </ul>
						...
						<div class="row">
							<div class="col-md-12">
								<form class="w-100" action="https://api.web3forms.com/submit" method="post">
									<input type="hidden" name="access_key" value="4b127bb5-8e0c-47a9-b4d0-583ae373242d">
                            <input type="hidden" name="redirect" value="https://web3forms.com/success">
                            <input type="hidden" name="from_name" value="Infinity Real Estate">
									<div class="row">
										<div class="row mb-4">
											...
											<div class="form-group col-lg-6">
												<input type="text"  name="Phone Number" class="form-control" placeholder="Phone" maxlength="10">
											</div>
											<div class="form-group col-lg-6">
