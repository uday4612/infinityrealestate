...
<!--	Title
	=========================================================-->
<title>Infinity Real Estate</title>
</head>
<body>
                            ...
                            <form method="post" action="contact.php">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-lg-2">
                                        <div class="form-group">
                                            <button type="submit" name="filter" class="btn btn-primary w-100">Make an Enquiry</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
        ...
        <div class="full-row">
            <div class="container">
                <div class="row">
                    ...
                    <h2 class="text-secondary text-center mb-4">Property Listing Coming Soon</h2>
                        ...
                        <div class="living-list pr-4">
                            ...
                            <ul>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										<h5 class="mb-3">Unmatched Expertise</h5>
										<p>Our team of seasoned real estate professionals brings extensive knowledge and experience to the table, ensuring you receive the best advice and guidance.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>We understand that every client is unique, and we tailor our services to meet your specific needs and preferences. Your goals are our goals.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									<i class="flaticon-seller flat-medium float-left d-table mr-4 text-primary" aria-hidden="true"></i>
									<div class="pl-2">
										<h5 class="mb-3">Market Knowledge</h5>
										<p>With an in-depth understanding of the local market trends and insights, we provide accurate information to help you make informed decisions.</p>
									</div>
                                </li>
                            </ul>
                        </div>
